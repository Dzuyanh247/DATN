...
public static class SeedData
{
    public static async Task InitializeAsync(ApplicationDbContext db)
    {
        ...
        if (cpuCount < 5)
        {
            ...
            {
                new() { Name = "CPU Intel Core i3-14100F", Slug = "cpu-intel-core-i3-14100f", ProductCode = "CPU-I3-14100F", Brand = "Intel", Price = 2990000, StockQuantity = 12, CategoryId = linhKienCategoryId, ThumbnailImage = "https://res.cloudinary.com/demo/image/upload/v1312461204/sample.jpg", ShortDescription = "CPU Intel phổ thông", Description = "4 nhân 8 luồng", DetailDescription = "Phù hợp gaming/esport", Specifications = "Core i3-14100F", WarrantyMonths = 36, WarrantyDuration = "36 tháng", ProductType = ProductKinds.Component, ComponentType = "CPU", IsInStock = true, IsActive = true },
                new() { Name = "CPU Intel Core i5-14600K", Slug = "cpu-intel-core-i5-14600k", ProductCode = "CPU-I5-14600K", Brand = "Intel", Price = 7890000, StockQuantity = 9, CategoryId = linhKienCategoryId, ThumbnailImage = "https://res.cloudinary.com/demo/image/upload/v1312461204/flower.jpg", ShortDescription = "CPU Intel tầm trung", Description = "Hiệu năng cao cho game", DetailDescription = "Core i5 thế hệ 14", Specifications = "Core i5-14600K", WarrantyMonths = 36, WarrantyDuration = "36 tháng", ProductType = ProductKinds.Component, ComponentType = "CPU", IsInStock = true, IsActive = true },
                new() { Name = "CPU Intel Core i7-14700K", Slug = "cpu-intel-core-i7-14700k", ProductCode = "CPU-I7-14700K", Brand = "Intel", Price = 10990000, StockQuantity = 7, CategoryId = linhKienCategoryId, ThumbnailImage = "https://res.cloudinary.com/demo/image/upload/v1312461204/animals.jpg", ShortDescription = "CPU Intel cao cấp", Description = "Tối ưu đa nhiệm", DetailDescription = "Core i7 thế hệ 14", Specifications = "Core i7-14700K", WarrantyMonths = 36, WarrantyDuration = "36 tháng", ProductType = ProductKinds.Component, ComponentType = "CPU", IsInStock = true, IsActive = true },
                new() { Name = "CPU AMD Ryzen 5 7500F", Slug = "cpu-amd-ryzen-5-7500f", ProductCode = "CPU-R5-7500F", Brand = "AMD", Price = 4190000, StockQuantity = 15, CategoryId = linhKienCategoryId, ThumbnailImage = "https://res.cloudinary.com/demo/image/upload/v1312461204/couple.jpg", ShortDescription = "CPU AMD gaming", Description = "6 nhân 12 luồng", DetailDescription = "Giá tốt cho AM5", Specifications = "Ryzen 5 7500F", WarrantyMonths = 36, WarrantyDuration = "36 tháng", ProductType = ProductKinds.Component, ComponentType = "CPU", IsInStock = true, IsActive = true },
                new() { Name = "CPU AMD Ryzen 7 7800X3D", Slug = "cpu-amd-ryzen-7-7800x3d", ProductCode = "CPU-R7-7800X3D", Brand = "AMD", Price = 9990000, StockQuantity = 6, CategoryId = linhKienCategoryId, ThumbnailImage = "https://res.cloudinary.com/demo/image/upload/v1312461204/sample.jpg", ShortDescription = "CPU AMD cao cấp", Description = "Tối ưu gaming 3D V-Cache", DetailDescription = "Hiệu năng game hàng đầu", Specifications = "Ryzen 7 7800X3D", WarrantyMonths = 36, WarrantyDuration = "36 tháng", ProductType = ProductKinds.Component, ComponentType = "CPU", IsInStock = true, IsActive = true }
            };
        ...
        if (!await db.Products.AnyAsync(p => accessoryTypes.Contains(p.ComponentType)))
        {
            ...
            db.Products.AddRange(
                new Product { Name = "Màn hình ASUS TUF Gaming VG249Q3A 24 inch 180Hz", Slug = "man-hinh-asus-tuf-vg249q3a", ProductCode = "MON-ASUS-VG249Q3A", Brand = "ASUS", Price = 3990000, DiscountPrice = 3590000, SalePrice = 3590000, StockQuantity = 10, CategoryId = accessoryCategoryId, ThumbnailImage = "https://ttgshop.vn/media/category/cat_big_1003486567.png", ShortDescription = "Màn hình gaming FHD 180Hz", Description = "Màn hình IPS 24 inch, Full HD, 180Hz.", DetailDescription = "Màn hình IPS 24 inch, Full HD, 180Hz.", Specifications = "24 inch | FHD | 180Hz | IPS", WarrantyMonths = 36, WarrantyDuration = "36 tháng", ProductType = ProductKinds.Component, ComponentType = "Monitor", IsInStock = true, IsActive = true },
                new Product { Name = "Bàn phím cơ AKKO 3087 RGB", Slug = "ban-phim-co-akko-3087-rgb", ProductCode = "KEY-AKKO-3087", Brand = "AKKO", Price = 1490000, DiscountPrice = 1290000, SalePrice = 1290000, StockQuantity = 15, CategoryId = accessoryCategoryId, ThumbnailImage = "https://ttgshop.vn/media/category/cat_big_1003353341.png", ShortDescription = "Bàn phím cơ TKL RGB", Description = "Layout TKL, switch cơ, RGB.", DetailDescription = "Layout TKL, switch cơ, RGB.", Specifications = "TKL | Mechanical | USB-C | RGB", WarrantyMonths = 12, WarrantyDuration = "12 tháng", ProductType = ProductKinds.Component, ComponentType = "Keyboard", IsInStock = true, IsActive = true },
                new Product { Name = "Chuột Logitech G304 Lightspeed", Slug = "chuot-logitech-g304-lightspeed", ProductCode = "MOU-LOGI-G304", Brand = "Logitech", Price = 990000, DiscountPrice = 790000, SalePrice = 790000, StockQuantity = 20, CategoryId = accessoryCategoryId, ThumbnailImage = "https://ttgshop.vn/media/category/cat_big_1003353370.png", ShortDescription = "Chuột gaming không dây", Description = "Kết nối Lightspeed, cảm biến HERO.", DetailDescription = "Kết nối Lightspeed, cảm biến HERO.", Specifications = "Wireless | HERO | 12000 DPI", WarrantyMonths = 24, WarrantyDuration = "24 tháng", ProductType = ProductKinds.Component, ComponentType = "Mouse", IsInStock = true, IsActive = true },
                new Product { Name = "Tai nghe HyperX Cloud Stinger 2", Slug = "tai-nghe-hyperx-cloud-stinger-2", ProductCode = "HP-HYPERX-STINGER2", Brand = "HyperX", Price = 1290000, DiscountPrice = 1090000, SalePrice = 1090000, StockQuantity = 12, CategoryId = accessoryCategoryId, ThumbnailImage = "https://ttgshop.vn/media/category/cat_big_1004013226.jpg", ShortDescription = "Tai nghe gaming âm thanh vòm", Description = "Micro chống ồn, đệm tai êm.", DetailDescription = "Micro chống ồn, đệm tai êm.", Specifications = "3.5mm | Stereo | Mic chống ồn", WarrantyMonths = 24, WarrantyDuration = "24 tháng", ProductType = ProductKinds.Component, ComponentType = "Headphone", IsInStock = true, IsActive = true }
            );
            await db.SaveChangesAsync();
        }
