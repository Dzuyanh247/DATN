...
public partial class AddPositionToBanners : Migration
{
...
BEGIN
    ALTER TABLE [Banners] ADD [Position] nvarchar(40) NOT NULL CONSTRAINT [DF_Banners_Position] DEFAULT('MainBanner');
    UPDATE [Banners] SET [Position] = 'MainBanner' WHERE [Position] IS NULL OR [Position] = '';
END
");
    }
